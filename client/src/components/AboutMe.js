        ...
        return (
            <section id="sobre-mi" class="sections-config">
                ...
                <div style={{fontWeight: 400}}>
                    ...
                    <br /><br />
                    <p class="text-center" style={{fontWeight:'800'}}>Me gustan muchos caminos pero mi preferido es en el que la tecnología se encuentra con el arte porque admiro</p>
                    <p class="text-center" style={{fontWeight:'800'}}>cuando la tecnología nos hace sentir más humanos.</p>
                </div>
                <Arrows to="#proyectos" />
            </section>
        );
